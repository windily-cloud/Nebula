...
import { codes } from "./micromark-util-symbol/code";
...
// copy from https://github.com/datopian/portaljs * - `wikiLinkTarget`: The target of the link (the part before the alias divider)
